...
if __name__ == "__main__":
    print(os.path.dirname(__file__) + './dmreg.dll')
    m_dm = DM(os.path.dirname(__file__) + './dmreg.dll', os.path.dirname(__file__) + './dm.dll')

    try:
        print(m_dm.Reg('mh84909b3bf80d45c618136887775ccc90d27d7', 'm6gbr8n5arik7k7'))
        # hwnds = m_dm.EnumWindow(0, "", "SunAwtFrame", 2)
        # print(hwnds)
        m_dm.BindWindowEx(463306, "gdi", "dx", "dx", "", 0)
        # m_dm.MoveTo(310, 370)
        # m_dm.delay(500)
        # m_dm.LeftClick()
        find_ret = m_dm.FindColor(223, 68, 278, 101, "1b9984", 0.6, 0).wait_until(5)
        print(find_ret[0])
